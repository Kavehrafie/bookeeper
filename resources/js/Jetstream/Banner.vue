<template>
    <div class="banner fixed w-full flex mt-2 top-0 z-50 justify-center">
        <transition enter-active-class="ease-out duration-300"
            ...
            <div class="banner--content shadow-lg rounded"
                    ...
                    <div class="flex items-center justify-between flex-wrap">
                        ...
                        <div class="flex-shrink-0 sm:ml-3">
                            <button
                                ...
                                :class="{ 'hover:bg-black hover:bg-opacity-50 focus:bg-black ': style == 'success', 'hover:bg-red-600 focus:bg-red-600': style == 'danger' }"
                                aria-label="Dismiss"
